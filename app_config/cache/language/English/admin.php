...
$lang_addl = array (
  ...
  'trashbin' => 'Trash bin',
  'censoring' => 'Censoring',
  'iptracker' => 'Forum IP Tracker',
  'usergroups' => 'User groups',
  'extensions' => 'Extensions',
  'newban' => 'Add new ban (will not apply to the main site)',
  'editban' => 'Edit ban',
  'deleteban' => 'Delete ban (if they are banned on the main site, they will need to be delete twice)',
  'expires' => 'Expires',
  'never' => 'Never',
  ...
  'adminprivs' => 'Mod Share Team status',
  'adminprivsdesc' => 'This option gives users access to the complete admin panel. (for the Mod Share team only)',
  ...
  'verifyregsdesc' => 'Verify new user registrations by emailing them an access code (DO NOT CHECK! THE EMAILS USED ARE FAKE!!)',
  'disableregsdesc' => 'Do not allow new registrations (users can still register via their main site account)',
  'general' => 'General',
  ...
  'announcementdesc' => 'Here you may specify an announcement to appear in the top banner under the navigation bar. If you have entered an announcement on the main site, you must enter it again here.',
  'enableannouncement' => 'Enable announcement?',
  'siteappearance' => 'Site appearance',
  'customfooter' => 'Here you may specify custom text to appear below the Mod Share Footer.',
